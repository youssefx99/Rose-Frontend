...
/** Carbon modal: white layer, subtle border, shadow (it floats). See design/08 §8. */
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-md border border-border-subtle bg-card p-6 text-card-foreground shadow-2xl duration-[var(--dur-moderate-02)] sm:max-w-lg",
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("type-heading-03 text-text-primary", className)}
      {...props}
    />
  );
}
